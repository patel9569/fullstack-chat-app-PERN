...
const SignUpPage = () => {
  ...
  const { signup, isSigningUp,googleAuth,isAuthGoogle } = UserAuthStore();
      ...
      <div className="flex flex-col justify-center items-center p-6 sm:p-12">
        <div className="w-full max-w-md space-y-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button  type ="button"className="btn bg-white text-black border-[#e5e5e5] w-full"  onClick={googleAuths} disabled={isAuthGoogle} >
              {isAuthGoogle?(
                <>
                <Loader2 className="size-5 animate-spin" />
                  Loading...
